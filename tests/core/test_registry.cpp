...
static void frozen_counts() {
  ...
  CHECK_EQ(core::kModuleCount, 19u);     // Phase B DRONE 5 classic voice slice (Codex msg 6e25b926):
                                         // +1 module (drone_5 id 18, source, 19 params/3 jacks).
                                         // Prior: DRONE 4 classic voice slice (Codex msg 483a9dc5)
                                         ...
                                         // envelope_b.
  CHECK_EQ(core::kParameterCount, 210u); // Phase B DRONE 5 classic voice slice (Codex msg 6e25b926):
                                         // +19 params (drone_5.tune_1..5 / mute_1..5 / mod_1..5 /
                                         // volt / att / rls continuous + gate_hold selector,
                                         // ids 258-276, software-normalized placeholders).
                                         // Prior: DRONE 4 classic voice slice (Codex msg 483a9dc5)
                                         // +19 (ids 239-257), DRONE 2 classic voice slice (Codex msg
                                         ...
                                         // carry 204, programs 6. Left as honest gaps the
                                         // drone_3/6 voice params + 12 keyboard
                                         ...
                                         // ranges)
  CHECK_EQ(core::kJackCount, 54u);       // Phase B DRONE 5 classic voice slice (Codex msg 6e25b926):
                                         // +3 patchable jacks (drone_5.cv_mod_in/.gate_in/.env_out,
                                         // ids 52-54; for env_out the nominalRange + polarity stay
                                         ...
                                         // Prior: DRONE 4 classic voice slice (Codex msg 483a9dc5)
                                         // +3 (drone_4.cv_mod_in/.gate_in/.env_out, ids 49-51),
