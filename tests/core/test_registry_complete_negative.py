...
def main():
    ...
    # The 111/64 (was 113/66) reflects the fm_in revert (task #32, frozen-P0 removal): vco_a.fm_in
    # (id 2) + vco_b.fm_in (id 65) were over-recorded — manual L388 "linear FM input with
    # attenuator" is the cv jack + cv amt attenuator + lin/exp switch set to lin, NOT a dedicated
    # fm_in. The vco_b mirror (manual L411) keeps only vco_b.vca_ctl (id 66). Patchable count drops
    # 66 -> 64, total 113 -> 111.
