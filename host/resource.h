...
//
// host/resource.h — SWELL dialog + menu resource IDs for the Lunar 24 host
// standalone. These mirror the reference IPlugVisualizer IDs so that the
// stock iPlug2 APP sources (IPlugAPP_dialog.cpp / IPlugAPP_main.cpp logic we
// re-host in main.mm) resolve every ID they reference. IDOK/IDCANCEL/IDC_STATIC
// are predefined by SWELL (swell-types.h / swell-dlggen.h), so they are not
// repeated here.
