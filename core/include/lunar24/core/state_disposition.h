...
inline constexpr DispositionEntry kDeviceStateDisposition[kDeviceStateDispositionCount] = {
    ...
    { ParameterId::drone_3_hi_low, StateDisposition::transfer_unavailable },
    ...
    { ParameterId::drone_6_hi_low, StateDisposition::transfer_unavailable },
    { ParameterId::drone_6_fm, StateDisposition::applied_to_dsp },
    { ParameterId::drone_6_am, StateDisposition::applied_to_dsp },
    { ParameterId::drone_6_rate_switch, StateDisposition::transfer_unavailable },
