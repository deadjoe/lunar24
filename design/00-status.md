...
**最后更新**：2026-08-26 · head `f73d4e3` · 分支 `feat/p0-full-registry` · main `1945878` 未动 · 无 PR#2
...
| **P4 演奏系统与输入适配** | ▶ **进行中：P4-① 统一输入状态机 + 三路等价** |
| P5 面板 / P6 dual effector | 未开始 |

门禁基线：本机 ctest **30/30**；CI build-and-test **4/4 绿**；
