...
| **P5 整张面板** | ▶ **进行中**：①自撰宿主+真窗消费 fit ✅（task #31，head `45109ed`；**task #15 已在一次真跑过的运行上关闭**，独立探针实测 FIT 2181×1410 vs CLAMP 2400×1410）／②唯一可逆 transform + 命中测试 ✅（task #33，head `7e1fa5b`，ctest 42/42，见 §2k）／③按区域铺控件（几何+命中）◀ **mandate 已发 `b922490a`** |
...
### P5-② 唯一可逆 transform + 命中测试（task #33 → done）
